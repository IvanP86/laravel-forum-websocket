<template>
    <div>
        <div class="flex items-center mb-4">
            ...
            <template v-if="checkBranchAuth(branch, section)">
                <Link :href="route('branches.themes.create', branch.id)"
                    class="block mr-4 w-1/6 px-2 py-1 bg-white border border-x-gray-300 rounded-lg text-center">+ Тема
                </Link>
            </template>
        </div>
        <div class="mb-8">
...
export default {
    ...
    methods: {
        checkBranchAuth(branch, section) {
