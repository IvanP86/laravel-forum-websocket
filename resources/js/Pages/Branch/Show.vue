    ...
    <div>
        <div class="flex items-center mb-4">
            ...
            <Link :href="route('branches.themes.create', branch.id)"
                class="block mr-4 w-1/6 px-2 py-1 bg-white border border-x-gray-300 rounded-lg text-center">+ Тема</Link>
        </div>
        <div class="mb-8">
            <div class="mb-4">
            ...
            <div v-for="branch in branch.children" class="flex items-center">
                <Link :href="route('branches.show', branch.id)"
                    class="w-full flex items-center bg-white p-4 border border-gray-300">
                <div class="mr-4">
        ...
        <div>
            ...
            <div v-for="theme in branch.themes" class="flex items-center">
                <Link :href="route('branches.show', theme.id)" class="w-full flex items-center bg-white p-4 border border-gray-300">
                <div class="mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <Link :href="route('branches.edit', branch.id)" class="block bg-sky-600 mx-2 p-4 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
