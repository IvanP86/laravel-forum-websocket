<template>
    <div>
        <div class="flex items-center mb-4">
            <h3 class="text-xl mr-4">Изменить ветку</h3>
        </div>
        <div>
            ...
            <div >
                <a class="block py-2 w-1/4 bg-sky-500 border border-sky-600 text-white text-center"  @click.prevent="update" href="#">Сохранить</a>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        update() {
            this.$inertia.patch(`/branches/${this.branch.id}`, {section_id: this.section_id, parent_id: this.parent_id, title: this.title})
        },
